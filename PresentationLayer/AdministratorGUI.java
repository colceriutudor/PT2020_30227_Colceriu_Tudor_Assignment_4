...
public class AdministratorGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        openMenuWindow(jButton3, "ADD");


        jButton4.setText("delete item");
        openMenuWindow(jButton4, "REMOVE");
        ...
        jButton5.addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                EditItemWindow edit = new EditItemWindow();
                close();
    ...
    private void openMenuWindow(JButton jButton4, final String buttonName) {
        jButton4.addMouseListener(new MouseListener() {
            @Override
            public void mouseClicked(MouseEvent e) {
                MenuItemWindow add = new MenuItemWindow(buttonName);
                add.setVisible(true);
                close();
            }
